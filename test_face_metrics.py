...
def main():
    print("--- STARTING PERFORMANCE EVALUATION: Face ---")
    
    # 1. Load your Fall Model
    model_path = 'Smart_Surveillance_FYP_Train/face_model/weights/best.pt'
    ...
    print("\n" + "="*40)
    print("Graphs saved at: Model_Metrics/face_eval/")
