...
def main():
    ...
    model_path = 'Smart_Surveillance_FYP_Train/headwear_model/weights/best.pt'
    ...
    # 2. Run Validation
    metrics = model.val(
        data='headwear_dataset/data.yaml', 
        split='val',              
    ...
    print("\n" + "="*40)
    print("Graphs saved at: Model_Metrics/headwear_eval/")
